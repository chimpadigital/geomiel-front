                    ...
                    <div class="overflow-hidden d-slider1">
                        <ul class="mb-2 swiper-wrapper list-inline">
                            ...
                            <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                                <div class="card-body d-flex align-items-center justify-content-around">
                                    <div class="progress-detail">
                                        <h4 class="counter">Notificaciones</h4>
                                        <p class="mb-0">Ordenes Pendientes</p>
                                        <a href="ordenes-compra-pendiente.php" class="d-flex align-items-center btn-link">Ver todos
                                            <svg class="ms-2" width="7" height="12" viewBox="0 0 7 12" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="d-flex mb-3">
                        <h2 class="me-5">O/C pendientes de ingreso</h2>
                        <a href="ordenes-compra-pendiente.php" class="d-flex align-items-center btn-link">Ver todos
                            <svg class="ms-2" width="7" height="12" viewBox="0 0 7 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div id="search" class="card card-body rounded-pill d-flex justify-content-around text-center py-3">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-end"><a href="#"
                                                    class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#nueva-ordenModal">Ingresar</a></td>
                                        </tr>
                                        <tr>
                                            <td>OC2356</td>
                                            <td>5135</td>
                ...
                <div class="col-md-6">
                    <div class="d-flex mb-3">
                        <h2 class="me-5">Lotes pendientes de egreso</h2>
                        <a href="ordenes-compra-pendiente.php" class="d-flex align-items-center btn-link">Ver todos
                            <svg class="ms-2" width="7" height="12" viewBox="0 0 7 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
