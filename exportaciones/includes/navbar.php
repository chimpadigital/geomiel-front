            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3 w-100">
                                            <p class="mb-0 ">El tambor 2 de la OC 2315 fue observado.</p>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3 w-100">
                                            <p class="mb-0 ">La OC 2253 fue pagada.</p>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img src="../assets/images/shapes/money.svg">
                                        <div class="ms-3 w-100">
                                            <p class="mb-0 ">La OC 2365 fue pagada.</p>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img src="../assets/images/shapes/alert.svg">
                                        <div class="ms-3 w-100">
                                            <p class="mb-0 ">El tambor 52 de la OC 362 fue observado.</p>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3 w-100">
                                            <p class="mb-0 ">Se ha modificado la equivalencia en Tambor nuevo.</p>
                                        </div>
                                    </div>
                                </a>
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                        ...
                        <img src="../assets/images/avatars/06.png" alt="User-Profile"
                        ...
                        <div class="caption ms-3 d-none d-md-block ">
                            <h6 class="mb-0 caption-title">Marta Paris</h6>
                            <p class="mb-0 caption-sub-title">Comprador</p>
                        </div>
                    </a>
