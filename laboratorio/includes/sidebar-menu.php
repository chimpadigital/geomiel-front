            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu-01" role="button"
                        ...
                        <span class="item-name">Órden de compras</span>
                        <i class="right-icon">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu-01" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link" href="orden-pendiente.php">
                                <i class="icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="orden-analizadas.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name">Analizadas</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu-02" role="button"
                        ...
                        <span class="item-name">Lotes</span>
                        <i class="right-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu-02" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="lotes-analizados.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name">Analizados</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu-03" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link" href="homogeneizacion.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name">A homogeneizar</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="homogeneizacion-pendiente.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name">A analizar</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="homogeneizacion-analizadas.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name">Analizado</span>
                            </a>
                        </li>
                    </ul>
                </li>
