...
<body class="  ">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex align-items-center">
                                <div class="box-img">
                                    <img src="../assets/images/barrel.svg" width="100%">
                                </div>
        ...
        <div class="conatiner-fluid content-inner mt-n5 py-0">
                                                ...
                                                <table id="example" class="display table mb-0 table-striped" cellspacing="0" width="100%" data-toggle="data-table"  role="grid">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">Solidificación</th>
            ...
            <div class="btn-group my-5">
                <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                    data-bs-target="#ventanaExito">Guardar resultados</button>
            </div>
        </div>
        </div>
	...
	<script type="text/javascript" language="javascript" src="../assets/vendor/editor/examples/resources/syntax/shCore.js"></script>
	<script type="text/javascript" language="javascript" src="../assets/vendor/editor/examples/resources/demo.js"></script>
	<script type="text/javascript" language="javascript" src="../assets/vendor/editor/examples/resources/editor-demo.js"></script>
