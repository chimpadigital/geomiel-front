            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu-01" role="button"
                        ...
                        <span class="item-name">Órden de compra</span>
                        <i class="right-icon">
                    ...
                    <ul class="sub-nav collapse" id="horizontal-menu-01" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link" href="ordenes-compra-pendiente.php">
                                <i class="icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ordenes-compra-entregada.php">
                                <i class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                        fill="currentColor">
                                        <g>
                                ...
                                <span class="item-name">Entregada</span>
                            </a>
                        </li>
                    </ul>
                </li>
