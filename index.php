                        ...
                        <ul class="mb-2 swiper-wrapper list-inline">
                            <!-- <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                <div class="card-body d-flex align-items-center justify-content-around">
                                    <p class="mb-0">Generar <br>Nueva Orden</p>
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#nueva-ordenModal">
                                        <img src="assets/images/btn-modal-plus.svg">
                                    </a>
                                </div>
                            </li> 
                            <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                <div class="card-body d-flex align-items-center justify-content-around">
                                    <p class="mb-0">Añadir Nuevo <br> Proveedor</p>
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#nuevo-proveedorModal">
                                        <img src="assets/images/btn-modal-plus.svg">
                                    </a>
                                </div>
                            </li> -->
